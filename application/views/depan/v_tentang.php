...
<section class="our-teachers">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mb-5">Istana Maimun</h2>
                </div>
            </div>
            <div class="row">
                <?php foreach ($data->result() as $row) : ?>
                    <div class="col-xs-6 col-sm-8 col-md-12">
                        ...
                        <div class="page-image">
                          ...
                          <?php if(empty($row->tentang_photo)):?>
                            <img src="<?php echo base_url().'assets/images/blank.png';?>" class="img-fluid" alt="#">
                          <?php else:?>
                            <img src="<?php echo base_url().'assets/images/'.$row->tentang_photo;?>"alt="#">
                          <?php endif;?> 
                        </div>
                        <p class="page-script"><span><?php echo $row->tentang_deskripsi;?></span>
                    </div>
                <?php endforeach;?>
              </div>
            <!-- End row -->

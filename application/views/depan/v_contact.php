                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 contact-option">
                            <div class="contact-option_rsp">
                                ...
                                <form action="<?php echo site_url('contact/kirim_pesan');?>" method="post">
                                    ...
                                    <!-- // end .form-group -->
                                    <div class="form-group">
                                        <input type="email" class="form-control form-control-sm" placeholder="Email" name="xemail" required>
                                    </div>
                                    <!-- // end .form-group -->
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-sm" placeholder="Phone" name="xphone" required>
                                    </div>
                                    <!-- // end .form-group -->
                                    <div class="form-group">
                                        <textarea placeholder="Pesan" class="form-control form-control-sm" name="xmessage" required rows="5"></textarea>
                                    </div>
                                    <!-- // end .form-group -->

      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="<?php echo base_url().'admin/tiket'?>">
            <i class="fa fa-envelope"></i> <span>Tiket</span>
            <span class="pull-right-container">
  ...
  <div class="content-wrapper">
    ...
    ?>
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-10">
              <input type="hidden" name="id" value="<?php echo $b['status_id'];?>">
              <input type="text" name="xstatus" class="form-control" value="<?php echo $b['status'];?>" placeholder="OPEN / CLOSED ?" required/>
            </div>
            <!-- /.col -->
            <div class="col-md-2">

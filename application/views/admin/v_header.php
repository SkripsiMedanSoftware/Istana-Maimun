...
<header class="main-header">
    ...
    <a href="<?php echo site_url('');?>" class="logo">
      ...
      <span class="logo-mini">IM</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">ISTANA MAIMUN </span>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <?php
              ...
              $q=$this->db->query("SELECT * FROM tbl_admins WHERE admins_id='$id_admin'");
              $c=$q->row_array();
          ?>
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url().'assets/images/'.$c['admins_photo'];?>" class="user-image" alt="">
              <span class="hidden-xs"><?php echo $c['admins_nama'];?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url().'assets/images/'.$c['admins_photo'];?>" class="img-circle" alt="">

                <p>
                  <?php echo $c['admins_nama'];?>
                  <?php if($c['admins_level']=='1'):?>

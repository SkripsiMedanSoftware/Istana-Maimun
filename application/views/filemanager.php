...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets') ?>/rich-filemanager/src/css/libs-main.css" />
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets') ?>/rich-filemanager/src/css/filemanager.min.css" />
		<style type="text/css">
			...
			left: 0;
			display: block;
			background: white url(<?php echo base_url('assets') ?>/rich-filemanager/images/spinner.gif) no-repeat center center;
			z-index: 999;
			}
		</style>
		...
		<div class="fm-container">
			...
			<div class="fm-wrapper">
				...
				<script type="text/javascript">
					var base_url = "<?php echo base_url('assets/rich-filemanager/') ?>";
				</script>
				<script type="text/javascript" src="<?php echo base_url('assets') ?>/rich-filemanager/src/js/libs-main.js"></script>
				<script type="text/javascript" src="<?php echo base_url('assets') ?>/rich-filemanager/src/js/filemanager.min.js"></script>
